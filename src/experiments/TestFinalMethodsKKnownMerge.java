...
public class TestFinalMethodsKKnownMerge extends Experiment {
	...
	public void test(ProjectInput project, WordModel wordModel, String[] extensions) throws IOException {
		...
		DistanceFunction[] distances = {new CosineDistance(), new CosineDistance(),new CosineDistance(),new CosineDistance(),new ModifiedCosineDistance(), new CosineDistance(),new CosineDistance(),new CosineDistance()};
