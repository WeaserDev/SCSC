...
public class Test {
	public static void main(String[] args) throws Exception {
		...
		LSA svd = new LSA(features.getOccurenceTable(),30);
		...
		OccurenceClustering algorithm = new clustering.algorithms.Kmeans(svd.getDocumentDocumentTable(), 14, new clustering.distance.ModifiedCosineDistance(),new clustering.algorithms.kmeansUtils.KmeansInitializationPlusPlusDeterministic(new clustering.distance.CosineDistance(), 1));
