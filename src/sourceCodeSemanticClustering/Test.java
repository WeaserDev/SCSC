...
public class Test {
	public static void main(String[] args) throws Exception {
		...
		OccurenceClustering algorithm = new clustering.algorithms.KmeansDynamic(features.getOccurenceTable(), new clustering.evaluation.IntraSimilarity(new clustering.distance.CosineDistance(),regularizeIntraSimilarity), new clustering.distance.ModifiedCosineDistance(), new clustering.algorithms.kmeansUtils.KmeansInitializationPlusPlusDeterministic(new clustering.distance.CosineDistance(),1));
		...
		//OccurenceClustering algorithm = new clustering.algorithms.Kmeans(features.getOccurenceTable(), 10, new clustering.distance.ModifiedCosineDistance(),new clustering.algorithms.kmeansUtils.KmeansInitializationPlusPlusDeterministic(new clustering.distance.CosineDistance(), 1));
